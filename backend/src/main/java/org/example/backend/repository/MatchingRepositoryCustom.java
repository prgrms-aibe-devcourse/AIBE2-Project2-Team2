...
public interface MatchingRepositoryCustom {
    ...
    List<MatchingSummaryUserDto> findExpertMatchingSummaries(String expertEmail, MatchingSearchCondition condition, Pageable pageable);

    // 일반유저가 전문가와의 매칭 내역을 조회할 때
    List<MatchingSummaryExpertDto> findUserMatchingSummaries(String userEmail, MatchingSearchCondition condition, Pageable pageable);
}
