...
public class MatchingHistoryService {
    ...
    public Page<MatchingSummaryUserDto> getExpertMatchingHistories(String expertEmail, MatchingSearchCondition condition, Pageable pageable) {
    ...
    public Page<MatchingSummaryExpertDto> getUserMatchingHistories(String email, MatchingSearchCondition condition, Pageable pageable) {
