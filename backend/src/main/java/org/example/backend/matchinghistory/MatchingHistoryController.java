...
public class MatchingHistoryController {
    ...
    @ApiResponses({
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            array = @ArraySchema(schema = @Schema(implementation = MatchingSummaryDto.class)),
    ...
    @GetMapping("/expert")
    public ResponseEntity<List<MatchingSummaryDto>> getExpertMatchingHistories(
            Principal principal,
        ...
        List<MatchingSummaryDto> result = matchingHistoryService.getExpertMatchingHistories(email, condition, pageable);
