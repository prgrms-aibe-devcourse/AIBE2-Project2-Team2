...
import org.example.backend.report.dto.ReportStatusUpdateRequest;
import org.example.backend.report.dto.ReportUpdateRequest;
...
public class ReportController {
    ...
    public ResponseEntity<Void> reportByNickname(
    ...
    public ResponseEntity<List<ReportResponse>> getMyReports(
        ...
        String reporterEmail = principal.getName();
        return ResponseEntity.ok(reportService.getReportsByCurrentUser(reporterEmail));
    }
    ...
    public ResponseEntity<Void> updateStatus(
        ...
        reportService.updateReportStatus(id, request.getStatus(), email);
        return ResponseEntity.ok().build();
    }
    ...
    public ResponseEntity<Void> updateReport(
        ...
        String email = principal.getName();
        reportService.updateStatusAndComment(id, request.getStatus(), request.getResolverComment(), email);
        return ResponseEntity.ok().build();
    }
