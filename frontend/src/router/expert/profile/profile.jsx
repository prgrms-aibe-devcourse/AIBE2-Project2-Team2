...
import { Star, ExternalLink, Users, GraduationCap, Calendar, Globe, Facebook, Instagram, Twitter } from "lucide-react";
        ...
        <div className="flex gap-14">
          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="grid grid-cols-1 gap-8">
              ...
              <div>
                <label className="block font-semibold mb-4 text-gray-700">콘텐츠 ({userInfo.contents.length})</label>
                <div className="space-y-3">
                  {userInfo.contents.length === 0 ? (
                    <div className="bg-white rounded-lg border-2 p-6 flex flex-col items-center justify-center border-dashed border-gray-200 text-gray-400">
              ...
              <div>
                <label className="block font-semibold mb-4 text-gray-700">포트폴리오 ({userInfo.portfolios.length})</label>
                <div className="space-y-3">
