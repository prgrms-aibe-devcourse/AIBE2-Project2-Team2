          ...
          <div className="p-4 bg-gray-50 rounded-lg grid grid-cols-4 gap-4">
            ...
            <div className="flex-1 col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-1">
                {viewType === "expert" ? "의뢰인 닉네임" : "전문가 닉네임"}
              </label>
              <input
                  type="text"
            ...
            <div className="flex-1 col-span-2">
              ...
              <input
                  type="number"
                  placeholder="매칭 ID 입력"
                  value={searchFilters.matchingId}
                  onChange={(e) => handleFilterChange("matchingId", e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
            ...
            <button
                ...
                className={`col-span-1 h-10 px-4 py-2 rounded-md transition-colors flex items-center justify-center ${
                    hasFilterChanges()
              ...
              <div className="flex justify-center mt-8 gap-2">
                {Array.from({ length: pageInfo.totalPages }, (_, i) => (
                    <button
                        ...
                        disabled={pageInfo.pageNumber === i}
                    >
                      {i + 1}
                    </button>
                ))}
