                ...
                <div className="flex gap-14">
                    ...
                    <div className="flex flex-col items-center space-y-5">
                        <div className="relative w-36 h-36 rounded-full bg-gray-100 flex items-center justify-center overflow-hidden border border-gray-200">
                            <img
                                src={userInfo.profileImageUrl || "/api/placeholder/150/150"}
                                alt="프로필 이미지"
                        ...
                        <label
                            className="cursor-pointer inline-block rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-600 hover:bg-gray-100 transition duration-200"
                    ...
                    <div className="flex-1 space-y-8">
                            ...
                            {isEditingNickname ? (
                                <div className="flex items-center gap-3">
                                    <input
                                        ...
                                        className="flex-1 rounded-md border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
                                        autoFocus
                                        maxLength={17}
                                    />
                                    <button
                                ...
                                <div className="flex items-center justify-between">
                                    <input
                                        ...
                                        disabled
                                        className="flex-1 rounded-md border border-gray-200 bg-gray-50 px-4 py-3 cursor-not-allowed text-gray-500"
                                    />
                                    <button
                        ...
                        <div>
                            ...
                            <input
                                ...
                                disabled
                                className="w-full rounded-md border border-gray-200 bg-gray-50 px-4 py-3 cursor-not-allowed text-gray-500"
                            />
                            ...
                            <div className="flex space-x-4 items-center">
                                {userInfo.joinType === "KAKAO" && (
                                    <div className="rounded-full bg-yellow-300 w-9 h-9 flex items-center justify-center cursor-default shadow-sm">
                                        <img
                                            src="https://static.cdn.kmong.com/assets/icon/kakao-logo_v2.png"
                                            alt="카카오 계정 연동 상태"
                                            className="w-6 h-6"
                                        />
                                    </div>
